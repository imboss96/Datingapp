...
import img1 from '../src/assets/images/banner/shape/home3/04.jpg';
import img2 from '../src/assets/images/banner/shape/home3/05.jpg';
import img3 from '../src/assets/images/banner/shape/home3/06.jpg';
import img4 from '../src/assets/images/banner/shape/home3/07.jpg';
import img5 from '../src/assets/images/banner/shape/home3/08.jpg';
...
const tabContent: Record<number, { icon: string; title: string; desc: string }> = {
  0: { icon: 'fa fa-search', title: 'Smart Partner Search', desc: 'Use advanced filters to find exactly who you are looking for — by location, interests, age, and more. Our intelligent search surfaces the most compatible people first.' },
  1: { icon: 'fa fa-check-circle', title: '94% Compatibility Match', desc: 'Our matching algorithm analyzes your preferences, behavior, and profile to surface people you will genuinely connect with. Real compatibility, not just looks.' },
  2: { icon: 'fa fa-heart', title: 'Find Your Partner', desc: 'Browse verified profiles, send likes, and start conversations with people who match your energy. Your next great love story starts with a single message.' },
  3: { icon: 'fa fa-book', title: 'Live Success Stories', desc: 'Every day, real couples share how they found each other on LunesaLove. Read their journeys and let their stories inspire yours.' },
};
...
export default function LandingPage({ onOpenLoginModal }: { onOpenLoginModal?: () => void }) {
  ...
  const sliderImages = [
    { src: img1, icon: 'fa fa-heart' },
    { src: img2, icon: 'fa fa-users' },
    { src: img3, icon: 'fa fa-heart-o' },
    { src: img4, icon: 'fa fa-heartbeat' },
    { src: img5, icon: 'fa fa-diamond' },
  ];
  ...
  const members = [
    { name: 'Smith Johnson', status: 'Active 10 days ago', image: '/images/member/home3/01.jpg', icon: 'fa fa-user' },
    { name: 'Arika Q Smith', status: 'Active 15 days ago', image: '/images/member/home3/02.jpg', icon: 'fa fa-user-circle' },
    { name: 'William R Show', status: 'Active 10 days ago', image: '/images/member/home3/03.jpg', icon: 'fa fa-user' },
    { name: 'Hanna Marcovick', status: 'Active 10 days ago', image: '/images/member/home3/04.jpg', icon: 'fa fa-user-circle' },
    { name: 'James Okafor', status: 'Active 2 days ago', image: '/images/member/home3/05.jpg', icon: 'fa fa-user' },
    { name: 'Sara Mitchell', status: 'Active today', image: '/images/member/home3/06.jpg', icon: 'fa fa-user-circle' },
    { name: 'Carlos Vega', status: 'Active 5 days ago', image: '/images/member/home3/07.jpg', icon: 'fa fa-user' },
    { name: 'Amara Diallo', status: 'Active 3 days ago', image: '/images/member/home3/08.jpg', icon: 'fa fa-user-circle' },
  ];

  const stats = [
    { number: '2,000,000+', label: 'Members Worldwide', icon: 'fa fa-users' },
    { number: '628,590', label: 'Members Online', icon: 'fa fa-circle' },
    { number: '314,587', label: 'Men Online', icon: 'fa fa-male' },
    { number: '102,369', label: 'Women Online', icon: 'fa fa-female' },
  ];

  const locations = [
    { name: 'London, UK', image: '/images/meet/icon/02.jpg', icon: 'fa fa-map-marker' },
    { name: 'Barcelona, Spain', image: '/images/meet/icon/03.jpg', icon: 'fa fa-map-marker' },
    { name: 'Taj Mahal, India', image: '/images/meet/icon/04.jpg', icon: 'fa fa-map-marker' },
    { name: 'Dubai, UAE', image: '/images/meet/icon/05.jpg', icon: 'fa fa-map-marker' },
    { name: 'Paris, France', image: '/images/meet/icon/06.jpg', icon: 'fa fa-map-marker' },
  ];

  const stories = [
    { title: 'Dream places to visit and fall in love in 2025', category: 'Entertainment', image: '/images/story/author/01.jpg', icon: 'fa fa-plane' },
    { title: 'How we met — a love story that started with one message', category: 'Love Stories', image: '/images/story/author/02.jpg', icon: 'fa fa-envelope' },
    { title: 'Love looks not with the eyes, but with the mind', category: 'Inspiration', image: '/images/story/author/03.jpg', icon: 'fa fa-brain' },
  ];
      ...
      <div className="lp">
            ...
            <div className="lp-hero-img-wrap">
                  ...
                  <div key={idx} className={`lp-slide${activeSlide === idx ? ' active' : ''}`}>
                    <img
                      ...
                      onError={(e) => {
                        ...
                        el.parentElement!.innerHTML = `<i class="${slide.icon}" style="font-size:6rem"></i>`;
                      }}
                    />
                  </div>
                ))}
              ...
              <div className="lp-float-card lp-card-match">
                <div className="lp-card-match-inner">
                  <div className="lp-match-avatar"><i className="fa fa-comment"></i></div>
                  <div>
                ...
                <div className="lp-member-img">
                  <img
                    ...
                    onError={(e) => {
                      const el = e.target as HTMLImageElement;
                      el.style.display = 'none';
                      el.parentElement!.innerHTML = `<i class="${member.icon}" style="font-size:3rem"></i>`;
                    }}
                  />
                </div>
          ...
          <div className="lp-stats-grid">
            {stats.map((stat, idx) => (
              <div key={idx} className="lp-stat-card">
                <span style={{ fontSize: '1.8rem', marginBottom: '0.8rem', display: 'block' }}><i className={stat.icon}></i></span>
              ...
              <div key={idx} className="lp-location-card">
                <img
                  ...
                  onError={(e) => {
                    const el = e.target as HTMLImageElement;
                    el.style.display = 'none';
                    el.parentElement!.innerHTML = `<div class="lp-location-placeholder"><i class="${loc.icon}"></i></div><div class="lp-location-overlay"><div class="lp-location-name">${loc.name}</div></div>`;
                  }}
                />
        ...
        <section className="lp-section">
          ...
          <div className="lp-tab-content">
            <div className="lp-tab-icon"><i className={tabContent[activeTab].icon}></i></div>
                ...
                <div className="lp-story-thumb">
                  <img
                    ...
                    onError={(e) => {
                      const el = e.target as HTMLImageElement;
                      el.style.display = 'none';
                      el.parentElement!.innerHTML = `<div class="lp-story-placeholder"><i class="${story.icon}"></i></div>`;
                    }}
                  />
                </div>
        ...
        <section className="lp-section">
          ...
          <div className="lp-trust-grid">
            <div className="lp-trust-card">
              <div className="lp-trust-icon"><i className="fa fa-shield"></i></div>
            ...
            <div className="lp-trust-card">
              <div className="lp-trust-icon"><i className="fa fa-star"></i></div>
